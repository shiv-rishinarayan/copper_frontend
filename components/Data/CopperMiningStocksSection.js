  ...
  return (
    <section id="stocks" style={{ ...s.sec, ...s.secDark }}>
      <div style={s.w}>
        ...
        {/* Stock mini-charts row */}
        <div style={{ ...s.g4, marginBottom: "24px" }}>
          {[
        ...
        <div style={s.cbd}>
          ...
          <div style={{ overflowX: "auto" }}>
            <table style={s.dt}>
              <thead>
                <tr>
                  <th style={{ ...s.dtTh, ...s.dtThDark }}>Company / Ticker</th>
          ...
          <p style={{ ...s.csrc, ...s.csrcDark }}>
            ...
            approximate Apr 2026 &middot; Alpha Vantage daily prices (25 req/day
            free) &middot; All figures approximate
          </p>
        </div>

        {/* ETFs Section */}
        <div style={{ ...s.g2, marginTop: "18px" }}>
          <div style={s.cbd}>
            <div style={s.ch}>
              <div>
                <p style={{ ...s.cl, ...s.clDark }}>
            ...
            <p style={{ ...s.csrc, ...s.csrcDark }}>
              Source: ETF.com &middot; Fund prospectuses &middot; Fees as of Q1
              2026
            </p>
          </div>
